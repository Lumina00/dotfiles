...
sudo pacman -S --noconfirm --needed rustup cmake docker nodejs \
  ...
  flatpak amd-ucode p7zip btrfs-progs pipewire pipewire-pulse wireplumber vulkan-radeon xf86-video-amdgpu xdg-user-dirs nftables noto-fonts-cjk iwd ly bluez-{base,obex} tinyxxd \
