...
sudo pacman -S --noconfirm --needed rustup cmake docker nodejs \
  ...
  flatpak amd-ucode p7zip btrfs-progs pipewire pipewire-pulse wireplumber amdvlk mesa-vdpau vulkan-radeon libva-mesa-driver xorg-{server,xauth,xinit,xrandr} xf86-video-amdgpu xdg-user-dirs nftables noto-fonts-cjk iwd\
