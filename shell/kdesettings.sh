...
kwriteconfig5 --file plasmashellrc --group 'Action_0' --key 'Automatic' --type bool 'false'
kwriteconfig5 --file plasmashellrc --group 'Action_0' --key 'Number of commands' '1'
kwriteconfig5 --file plasmashellrc --group 'Action_0' --key 'Regexp' '^http.+(youtu|twitch)'
kwriteconfig5 --file plasmashellrc --group 'Action_0' --key 'Description' ''

kwriteconfig5 --file plasmashellrc --group 'Action_0/Command_0]' --key 'Commandline[$e]' 'mpv %s'
kwriteconfig5 --file plasmashellrc --group 'Action_0/Command_0]' --key 'Description' 'mpv'
kwriteconfig5 --file plasmashellrc --group 'Action_0/Command_0]' --key 'Enabled' --type bool 'true'
kwriteconfig5 --file plasmashellrc --group 'Action_0/Command_0]' --key 'Icon' 'mpv'
kwriteconfig5 --file plasmashellrc --group 'Action_0/Command_0]' --key 'Output' '0'
