...
sudo pacman -S --noconfirm --needed rustup ruby zsh refind bandwhich mpv lollypop firefox qbittorrent neovim flatpak docker \
  nomacs amd-ucode p7zip amdvlk btrfs-progs easytag yarn anthy lvm2 pipewire pipewire-pulse \
  gst-plugins-good qt5-imageformats mesa-vdpau vulkan-radeon plasma-desktop powerdevil bluedevil plasma-pa plasma-nm spectacle kscreen\
